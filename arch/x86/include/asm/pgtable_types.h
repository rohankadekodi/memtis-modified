...
typedef struct { uint32_t bottom_accesses; uint8_t nr_accesses; uint8_t cooling_clock; bool may_hot; uint32_t ltm; uint8_t do_migration; uint32_t recent_accesses; } pginfo_t;
